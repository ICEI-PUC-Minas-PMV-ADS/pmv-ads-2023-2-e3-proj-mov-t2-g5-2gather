...
![Diagrama de Casos de Uso](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2023-2-e3-proj-mov-t2-g5-2gather/assets/12260321/1f72af30-4ffd-44c6-857b-b419d8112766)


# Matriz de Rastreabilidade


| Importância | ID do Requisito | Nome                                                 | Tipo                     | Critérios de Aceitação                                           | Descrição |
|-------------|------------------|------------------------------------------------------|--------------------------|------------------------------------------------------------------|-----------|
| Must Have  | RF-01            | Comunicação em tempo real                           | Funcional                | Mensagens são entregues em tempo real e exibidas corretamente    | O sistema deve permitir a troca de mensagens em tempo real entre os usuários, garantindo que sejam entregues e exibidas corretamente.       |
| Must Have  | RF-02            | Interface de gerenciamento de usuários                           | Funcional                | Interface para adicionar, editar e remover usuários              | O sistema deve fornecer uma interface administrativa que permita aos administradores adicionar, editar e remover usuários do sistema.        |
| Must Have  | RF-03            | Criação de grupos                   | Funcional                | Usuários podem criar grupos de conversa              | O sistema deve possibilitar que os usuários criem grupos de conversa para facilitar a comunicação entre membros específicos.        |
| Must Have  | RF-04            | Listas de transmissão                                | Funcional                | Criação de listas de transmissão de mensagens                    | O sistema deve capacitar os usuários a criar listas de transmissão de mensagens, simplificando o envio para múltiplos destinatários.       |
| Should Have| RF-05            | Restrição de envio para administradores             | Funcional                | Mensagens podem ser enviadas somente por administradores        | O sistema deve restringir o envio de mensagens apenas para os administradores, garantindo a comunicação apropriada dentro do sistema.         |
...
| Should Have        | RNF-03              | A aplicação não deve ter tempo de resposta maior do que 30 segundos. | Não Funcional | Resposta do sistema em menos de 30 segundos                    | O sistema deve responder às ações dos usuários em um período de tempo inferior a 30 segundos.    |
| Should Have        | RNF-04              | A aplicação deve estar acessível e sem interrupções por pelo menos 95% do tempo, apresentando um tempo de inatividade mínimo. | Não Funcional | Disponibilidade do sistema superior a 95%                      | O sistema deve estar disponível para uso durante pelo menos 95% do tempo total.                                 |
