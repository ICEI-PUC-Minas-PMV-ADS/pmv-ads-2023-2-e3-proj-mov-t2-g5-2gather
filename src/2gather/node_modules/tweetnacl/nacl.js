...
function checkLengths(k, n) {
  console.log(k.length, 'a', crypto_secretbox_KEYBYTES)
  if (k.length !== crypto_secretbox_KEYBYTES) throw new Error('bad key size');
  if (n.length !== crypto_secretbox_NONCEBYTES) throw new Error('bad nonce size');
}

function checkBoxLengths(pk, sk) {
  console.log(sk.length, 'a', crypto_box_SECRETKEYBYTES)
...
nacl.box.keyPair.fromSecretKey = function(secretKey) {
  ...
  console.log(secretKey.lengt, 'b', crypto_box_SECRETKEYBYTES)
...
nacl.sign = function(msg, secretKey) {
  ...
  console.log(secretKey.length, 'c', crypto_sign_SECRETKEYBYTES)
...
nacl.sign.keyPair.fromSecretKey = function(secretKey) {
  console.log(secretKey.length, 'd', crypto_sign_SECRETKEYBYTES)
  checkArrayTypes(secretKey);
  if (secretKey.length !== crypto_sign_SECRETKEYBYTES)
    throw new Error('bad secret key size');
  var pk = new Uint8Array(crypto_sign_PUBLICKEYBYTES);
